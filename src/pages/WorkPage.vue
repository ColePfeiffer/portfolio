<template>
  <BaseCarousel :projectCount="projects.length">
    ...
    >
      <CarouselSlide>
        <BaseContainer
          :title="t('projectPath', { msg: project.containerTitle })"
        ...
        images: [
          {
            ...
            description: "Profile Page Edit Dialog",
            isVideo: false,
            fit: "cover",
          },
          {
            src: "images/RoomMe_05.png",
            description: "Task Creator Dialog",
            isVideo: false,
            fit: "cover",
          },
          {
            src: "images/RoomMe_01.png",
            description: "Chat / Message board",
            isVideo: false,
            fit: "cover",
          },
          {
            src: "images/RoomMe_04.png",
            description: "Finances Page",
            isVideo: false,
            fit: "cover",
          },
        ],
